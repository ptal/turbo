...
schedule(
    ...
    configurations=[
        ...
        Configuration(name="TurboGPU10_10", solver=minizinc.Solver.lookup("turbo.gpu.release"), other_flags={"-sub": 10, "-or": 10, "-version": "1.1.0", "-hardware" : "AMD EPYC 7452 32-Core@2.35GHz; RAM 512GO;NVIDIA A100 40GB HBM"}),
