...
counter_file=/project/scratch/p200244/lattice-land/turbo/benchmarks/profiling/${PARALLEL_SSHHOST}.count
lock_file=/project/scratch/p200244/lattice-land/turbo/benchmarks/profiling/${PARALLEL_SSHHOST}.lock
