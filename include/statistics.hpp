...
struct Statistics {
  ...
  CUDA Statistics(size_t variables, size_t constraints, size_t num_tables, size_t num_refinements, bool optimization):
    variables(variables), constraints(constraints), num_tables(num_tables), num_refinements(num_refinements), optimization(optimization),
  ...
  CUDA Statistics(): Statistics(0,0,0,0,false) {}
...
public:
  CUDA void print_mzn_statistics() const {
    ...
    print_stat("num_refinements", num_refinements);
