...
schedule(
    ...
    timeout=timedelta(seconds=300),
    configurations=[
        Configuration(name="TurboGPU", solver=minizinc.Solver.lookup("turbo.gpu.release"), extra_data={"-sub": 10, "-version": "1.1.0", "-hardware" : "Intel Core i9-10900X@3.7GHz;24GO DDR4;NVIDIA RTX A5000"})
    ],
    nodelist=None
)
