...
parallel $MULTINODES_OPTION --rpl '{} uq()' --jobs $NUM_GPUS -k --colsep ',' --skip-first-line $MZN_COMMAND {2} {3} -sub {4} '|' python3 $DUMP_PY_PATH $OUTPUT_DIR {1} {2} {3} $MZN_SOLVER "sub"{4} :::: $INSTANCE_FILE ::: 10 12
