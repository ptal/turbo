...
schedule(
    ...
    configurations=[
        ...
        Configuration(name="TurboGPU", solver=minizinc.Solver.lookup("turbo.gpu.release"), other_flags={"-sub": 12, "-version": "1.1.0", "-hardware" : "Intel Core i9-10900X@3.7GHz;24GO DDR4;NVIDIA RTX A5000"})
